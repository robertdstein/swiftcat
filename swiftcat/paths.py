...
def get_directory_from_env(env_var: str, default: Path) -> Path:
    """
...
def get_image_dir() -> Path:
    ...
    """
    return get_directory_from_env("SWIFT_IMAGE_DIR", DEFAULT_IMAGE_DIR)
...
def get_data_dir() -> Path:
    ...
    """
    return get_directory_from_env("SWIFTCAT_DATA_DIR", DEFAULT_DATA_DIR)
